...
public class AmbilWarnaDialog {
	...
	public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
		...
		Button btn_ok_cp = dialog.findViewById(R.id.btn_ok_cp);
		Button btn_cancel_cp = dialog.findViewById(R.id.btn_cancel_cp);

		btn_ok_cp.setOnClickListener(new View.OnClickListener() {
			@Override
